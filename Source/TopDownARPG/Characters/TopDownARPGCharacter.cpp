...
void ATopDownARPGCharacter::CheckForInteractables()
{
	ATopDownARPGPlayerController* IController = Cast<ATopDownARPGPlayerController>(GetController());
	if (IController != nullptr)
	{
		FHitResult HitResult(ForceInit);
		IController->GetHitResultUnderCursor(ECollisionChannel::ECC_WorldDynamic, false, HitResult);
